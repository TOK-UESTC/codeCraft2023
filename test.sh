...
then
    ...
    # clear error.txt
    echo "" > error.txt
    ../robot.exe "java -Xmn512m -Xms1024m -Xmx1024m -XX:MaxGCPauseMillis=1 -classpath ./bin com.huawei.codecraft.Main restart" -f -d -m  ../oldMaps/1.txt >> error.txt
    ../robot.exe "java -Xmn512m -Xms1024m -Xmx1024m -XX:MaxGCPauseMillis=1 -classpath ./bin com.huawei.codecraft.Main restart" -f -d -m  ../oldMaps/2.txt >> error.txt
    ../robot.exe "java -Xmn512m -Xms1024m -Xmx1024m -XX:MaxGCPauseMillis=1 -classpath ./bin com.huawei.codecraft.Main restart" -f -d -m  ../oldMaps/3.txt >> error.txt
    ../robot.exe "java -Xmn512m -Xms1024m -Xmx1024m -XX:MaxGCPauseMillis=1 -classpath ./bin com.huawei.codecraft.Main restart" -f -d -m  ../oldMaps/4.txt >> error.txt
